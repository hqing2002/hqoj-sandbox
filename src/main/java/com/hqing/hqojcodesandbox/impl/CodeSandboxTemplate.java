...
import com.hqing.hqojcodesandbox.impl.strategy.RunStrategy;
import com.hqing.hqojcodesandbox.impl.strategy.RunStrategyManager;
...
import com.hqing.hqojcodesandbox.impl.strategy.model.RunCodeStrategyEnum;
...
public abstract class CodeSandboxTemplate implements CodeSandbox {
    ...
    protected List<ExecuteMessage> runCodeFile(File userCodeFile, List<String> inputList) throws Exception {
        RunStrategy runStrategy = runStrategyManager.getInstance(RunCodeStrategyEnum.DOCKER.getStrategyName());
    ...
    public ExecuteCodeResponse executeCode(ExecuteCodeRequest executeCodeRequest) {
        ...
        //1. 把用户代码存入文件
        File userCodeFile = createCodeFile(code);
        try {
            //2. 编译用户代码, 得到class文件
